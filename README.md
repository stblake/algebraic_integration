...
Out[2017]= {0, 0, ((2 + x - x^3 - x^4)^(2/3) (-(6/5) - (3 x)/5 - (9 x^3)/10 + (3 x^4)/5))/x^5 - Sqrt[3] ArcTan[(x/Sqrt[3] + (2 (2 + x - x^3 - x^4)^(1/3))/Sqrt[3])/x] + Log[x] - Log[x^2]/2 - Log[x - (2 + x - x^3 - x^4)^(1/3)] + 1/2 Log[x^2 + x (2 + x - x^3 - x^4)^(1/3) + (2 + x - x^3 - x^4)^(2/3)]}

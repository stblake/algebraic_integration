...
can express this integral in terms of an Appell hypergeometric function, 
\href{https://reference.wolfram.com/language/ref/AppellF1.html}{$F_1$}.
\begin{multline*}
\int\frac{1}{2 u \sqrt[4]{u^2+u-1}}du = \\
-\frac{\sqrt[4]{\frac{1-\sqrt{5}}{2 u}+1} \sqrt[4]{\frac{1+\sqrt{5}}{2 u}+1}}{\sqrt[4]{u^2+u-1}} 
...
In this example, the integral $$\int\frac{du}{2 u \sqrt[4]{u^2-1}},$$ does not return an elementary 
